...
#coding=utf-8
#Ali-Rastagar
#Instagram:@Ali.Rastagar
#Telegram :t.me/Hacking_by_Ali
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mAli.Rastagar█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            print """
            \033[1;92mWelcome Ali-Rastagar Zone
                  """
            loop = 'false'
    else:
...
def action():
    ...
    jalan ("\033[1;92mAli~Rastagar██████▒▒▒..99%Start Cracking...")
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'Ali~Rastagar Process Has Been Completed██████▒▒▒▒...100%'
...
\033[1;92m My Telegram\033[1;97mAliRastagarHacker007
\033[1;93mGitHub\033[1;97mAliRastagarHacker007
\033[1;94mInstagram\033[1;97m∆@Ali.Rastagar"""
